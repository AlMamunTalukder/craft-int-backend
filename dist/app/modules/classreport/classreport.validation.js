...
exports.ClassReportValidations = void 0;
const zod_1 = require("zod");
const createClassReportValidation = zod_1.z.object({
    body: zod_1.z.object({
        teachers: zod_1.z.string({ required_error: 'Teacher is  required!' }),
        classes: zod_1.z.string({ required_error: 'Classes is  required!' }),
        subjects: zod_1.z.string({ required_error: 'Subject is  required!' }),
        hour: zod_1.z
            .string({
        ...
        studentEvaluations: zod_1.z
            .array(zod_1.z.object({
            studentId: zod_1.z.string({
                required_error: 'Student ID is required',
            }),
            lessonEvaluation: zod_1.z.enum(["পড়া শিখেছে", "আংশিক শিখেছে", "পড়া শিখেনি", "অনুপস্থিত", "পাঠ নেই"], {
                required_error: 'Lesson evaluation is required',
            }),
            handwriting: zod_1.z.enum(["লিখেছে", "আংশিক লিখেছে", "লিখেনি", "কাজ নেই", 'অনুপস্থিত'], {
                required_error: 'Handwriting evaluation is required',
            }),
            attendance: zod_1.z.enum(['উপস্থিত', 'অনুপস্থিত', 'ছুটি'], {
                required_error: 'Attendance status is required',
            }),
            parentSignature: zod_1.z.boolean({
                required_error: 'Parent signature is required',
            }),
            comments: zod_1.z.string().optional(),
        }))
            .min(1, 'At least one student evaluation is required'),
        todayLesson: zod_1.z.string().nullable().optional(),
        homeTask: zod_1.z.string().nullable().optional(),
    }),
});
const updateClassReportValidation = zod_1.z.object({
    body: zod_1.z.object({
        teachers: zod_1.z.union([zod_1.z.string(), zod_1.z.array(zod_1.z.string())]).optional(),
        classes: zod_1.z.string({ required_error: 'Classes is  required!' }).optional(),
        subjects: zod_1.z.string({ required_error: 'Subject is  required!' }).optional(),
...
//   }),
// });
exports.ClassReportValidations = {
