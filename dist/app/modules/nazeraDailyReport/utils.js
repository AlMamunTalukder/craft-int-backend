...
exports.calculateWeeklySummary = void 0;
const calculateWeeklySummary = (dailyEntries) => {
    ...
    Object.values(dailyEntries).forEach(day => {
        ...
        if (duaMatch)
            totalDuas += parseInt(duaMatch[1]);
        if (hadithMatch)
            totalHadith += parseInt(hadithMatch[1]);
    });
    return {
        totalPages,
        totalMistakes,
...
exports.calculateWeeklySummary = calculateWeeklySummary;
